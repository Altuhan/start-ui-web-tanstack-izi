        ...
        <CardContent className="space-y-6 pt-6 text-sm leading-relaxed text-muted-foreground">
          <section className="space-y-2">
            ...
            <p>
              ...
              «Сервис»), включая веб-интерфейс, кассовое приложение и
              серверную инфраструктуру оператора.
            </p>
            <p>
          ...
          <section className="space-y-2">
            ...
            <p>
              ...
              организации через вход с учётной записью{' '}
          ...
          <section className="space-y-2">
            <h2 className="text-base font-semibold text-foreground">
              4. Работа кассы и синхронизация данных
            </h2>
            <p>
              Кассовое приложение может работать при ограниченном доступе к
              сети с локальным хранением данных на устройстве организации.
